...
public class ExcelDB {
    ...
    static final String F_RECETAS      = "recetas.csv";
    static final String F_ITEMS_RECETA = "items_receta.csv";
    static final String F_NOTAS_CRED   = "notas_credito.csv";
    static final String F_AUDITORIA    = "auditoria.csv";
    ...
    //  GENERADORES DE ID
    // ════════════════════════════════════════════════════════════
    public static String generarIdCita()     { return String.format("C%05d", contarRegistros(F_CITAS)+1); }
    public static String generarIdFactura()  { return String.format("F%05d", contarRegistros(F_FACTURAS)+1); }
    public static String generarIdNota()     { return String.format("NC%05d", contarRegistros(F_NOTAS_CRED)+1); }
