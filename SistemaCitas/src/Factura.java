/**
 * Factura — representa un documento de cobro generado tras
 * completar una cita médica.
 *
 * Campos:
 *   idFactura        : F00001..F99999
 *   idCita           : ID de la cita asociada
 *   usernamePaciente : username del paciente
 *   nombrePaciente   : nombre completo del paciente
 *   medicoUsername   : username del médico
 *   especialidad     : especialidad de la consulta
 *   fechaCita        : fecha de la cita
 *   subtotal         : valor antes de impuestos
 *   iva15            : IVA 15 %  (vigente Ecuador)
 *   total            : subtotal + iva15
 *   metodoPago       : Efectivo | Tarjeta de Crédito | Tarjeta de Débito |
 *                      Transferencia | Seguro Médico
 *   estadoPago       : Pagada | Pendiente | Anulada
 *   fechaEmision     : fecha en que se generó la factura
 */
